...
/**
 * Goldstandard_Sniffs_NamingConventions_ValidFunctionNameSniff based on PEAR_Sniffs_NamingConventions_ValidFunctionNameSniff.
 *
 * Ensures method names are correct depending on camelCaps, and that functions are named correctly. PSR compliant.
 *
 * @category PHP
 * @package PHP_CodeSniffer
 ...
 * @link http://pear.php.net/package/PHP_CodeSniffer
 */
class Goldstandard_Sniffs_NamingConventions_ValidFunctionNameSniff extends PEAR_Sniffs_NamingConventions_ValidFunctionNameSniff
{
    /**
    ...
    protected function processTokenWithinScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        if (preg_match('|^__|', $methodName) !== 0) {
            ...
            if (in_array($magicPart, $this->magicMethods, true) === false) {
